...
```
docker run -v /home/shiguredo/sora-2020.3/archive:/hisui ghcr.io/shiguredo/hisui:2021.2.2 -f /hisui/CSX77QY9F57V5BT72S62C28VS4/report-CSX77QY9F57V5BT72S62C28VS4.json
```
...
```
$ docker run ghcr.io/shiguredo/hisui:2021.2.2 hisui --help
hisui
